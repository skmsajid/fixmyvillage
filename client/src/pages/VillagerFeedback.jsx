      ...
      <div className="fb-page">
        ...
        <div className="fb-card fb-success-card">
          ...
          <p className="fb-success-sub">
            Your feedback helps us improve village services for everyone.
          </p>

          <button
            className="fb-return-btn"
        ...
        <div className="fb-header">
          ...
          <div className="fb-title-wrap">
            ...
            <p className="fb-subtitle">
              Help us make your village better
            </p>
          ...
          <div className="fb-section">
              ...
              {[1, 2, 3, 4, 5].map((star) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    className={`fb-star ${
                      isActive ? 'fb-star-active' : ''
                    } ${
                      isClicked ? 'fb-star-bounce' : ''
                    }`}
                    style={
                      isActive
                        ? {
            ...
            <div className="fb-rating-label">
              ...
              {displayRating > 0 ? (
                ...
                <>
                  <span className="fb-rating-emoji">
                    {RATING_EMOJIS[displayRating - 1]}
                  </span>

                  <span
                    className="fb-rating-text"
                    style={{
                      color:
                        RATING_COLORS[
                          displayRating - 1
                ...
                <span className="fb-rating-placeholder">
                  Tap a star to rate
                </span>
